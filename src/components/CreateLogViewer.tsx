...
interface CreateLogViewerProps {
  logs: CreateLog[];
}
...
export const CreateLogViewer: React.FC<CreateLogViewerProps> = ({ logs }) => {
  ...
  useEffect(() => {
    ...
    logs.forEach((log) => {
      ...
      try {
        ...
        switch (log.type) {
          case 'stdout':
            term.writeln(`\x1b[2m[${timeStr}]\x1b[0m ${log.message}`);
            break;
          case 'stderr':
            term.writeln(`\x1b[2m[${timeStr}]\x1b[0m \x1b[33m${log.message}\x1b[0m`);
            break;
          case 'error':
            term.writeln(`\x1b[2m[${timeStr}]\x1b[0m \x1b[31m✗ ${log.message}\x1b[0m`);
            break;
        }
